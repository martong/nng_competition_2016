...
constexpr int queenMaximumEnergy = 1600;
constexpr int queenEnertyRequirement = 200;
constexpr int queenStartingEnergy = queenEnertyRequirement;

constexpr int queenSpawnTime = 240;
